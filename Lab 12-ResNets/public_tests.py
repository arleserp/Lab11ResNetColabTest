    ...
    assert np.allclose(resume, 
                       np.array([[[  0.,        0.,        0.,        0.,     ],
                                 ...
                                 [[578.21246, 578.21246, 578.21246, 290.60623],
                                  [290.60623, 290.60623, 290.60623, 146.80312]]]), atol = 1e-1 ), "Wrong values with training=False"
    ...
    assert np.allclose(resume, 
                         np.array([[[0.,        0.,        0.,        0.       ],
                                   ...
                                   [[3.2379792, 4.139072,  4.139072,  3.2379792],
                                    [3.2379792, 4.139072,  4.139072,  3.2379792]]]), atol = 1e-1 ), "Wrong values with training=True"
